(function () {
  ...
  var translations = {
    en: {
      ...
      "personal.text": "Lives in Filderstadt, near Stuttgart, born in 1989. Shares his home with two cats, Miumiu and Baozi. Enjoys traveling and keeps a large plant collection — with a soft spot for growing chilis.",
    ...
    de: {
      ...
      "personal.text": "Lebt in Filderstadt bei Stuttgart, geboren 1989. Teilt sein Zuhause mit zwei Katzen, Miumiu und Baozi. Reist gerne und hat eine große Pflanzensammlung — mit einer Vorliebe fürs Chili-Anbauen.",
    ...
    zh: {
      ...
      "personal.text": "住在斯图加特附近的费尔德施塔特(Filderstadt),1989年出生。家里养了两只猫,Miumiu 和 Baozi。喜欢旅行,种了很多植物,尤其喜欢种辣椒。",
